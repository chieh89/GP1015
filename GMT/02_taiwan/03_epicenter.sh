...
echo 121.29 22.83 | gmt psxy -R -J -Sa0.7 -W0.01 -G255/0/0 -P -O -K >> $out_ps
...
echo "121.87 24.97 M:5.1 Depth:132.5km" | gmt pstext -R -J -O -K -F+f,Helvetica-Bold,black >> $out_ps
# end gmt session
